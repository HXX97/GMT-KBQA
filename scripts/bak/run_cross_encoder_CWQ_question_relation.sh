...
dataset='CWQ'
exp_prefix="data/${dataset}/relation_retrieval_0723/cross-encoder/saved_models/${exp_id}/"
log_dir="data/${dataset}/relation_retrieval_0723/cross-encoder/saved_models/${exp_id}/"
