...
dataset='WebQSP'
exp_prefix="data/WebQSP/relation_retrieval_final/cross-encoder/saved_models/${exp_id}/"
log_dir="data/WebQSP/relation_retrieval_final/cross-encoder/saved_models/${exp_id}/"
